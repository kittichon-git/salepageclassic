      ...
      <div className="px-7 md:px-10 pt-12 pb-8 md:pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-[18px] items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            {MECHANISM.map((s, i) => (
              <ScrollReveal key={s.n} delay={i * 0.1}>
                <div className="border border-border-default bg-bg-surface shadow-soft p-5">
          ...
          <ScrollReveal delay={0.25}>
            <div className="border border-border-default bg-bg-surface shadow-soft p-5 flex flex-col items-center justify-center min-h-[180px] gap-4">
              <div className="w-full aspect-video border border-border-default bg-bg-card flex items-center justify-center">
